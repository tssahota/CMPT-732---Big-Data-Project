...
def main(movie_path, genre_path):
    ...
    #movie_data.show(10)
    movie_data = movie_data.select( movie_data["vote_average"], movie_data["title"], movie_data["popularity"], movie_data["release_date"])
    ...
    sorted_movie_data = movie_data.where((movie_data['year'] > 2007) & (movie_data['year'] <= 2017)).drop("release_date")
