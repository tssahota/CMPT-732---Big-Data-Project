...
def main(input_dir, output_dir):
    ...
    movietube = movietube.join(youtube_df,  movietube['tmdb_id']==youtube_df['tmdb_id'],'left')\
                         .select(movietube['*'], youtube_df['youtube_views'].alias('youtube_views'), youtube_df['youtube_likes'].alias('youtube_likes'),\
                                 youtube_df['youtube_dislikes'].alias('youtube_dislikes'))
    movietube.cache()
    task18_df = movietube
    task18_df.show(5)
